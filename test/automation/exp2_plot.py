#!/usr/bin/env python3
"""Plot EXP2 throughput curves from CSV produced by exp2_run_auto.py."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plot EXP2 results.")
    parser.add_argument("--input", type=Path, default=Path("test/results/exp2_results.csv"))
    parser.add_argument("--output", type=Path, default=Path("test/results/exp2_figure.svg"))
    parser.add_argument("--title", default="EXP2: Unlimited-working-set In-Cache RX Path")
...
def main() -> int:
    ...
    print(f"[EXP2] figure saved to {args.output}")
    return 0
