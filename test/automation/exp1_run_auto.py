...
METHODS = [
    ("tx_rdma_assisted", "RDMA-assisted TX"),
    ("tx_dma_assisted", "DMA-assisted TX"),
    ("tx_header_only_offloading", "Header-only Offloading TX"),
]
    ...
    with open(args.output, "w", newline="", encoding="utf-8") as csv_fp:
        ...
        for method, method_label in METHODS:
            for payload_size in payload_sizes:
                ...
                memory_log = args.log_dir / f"{run_tag}_bf1_memory.log"
                run_index += 1
                ...
                try:
                    ...
                    if args.collect_memory:
                        graceful_stop_remote(bf1, args.workdir, Path(args.memory_script).name, memory_proc, args.stop_timeout)
                ...
                if args.collect_memory:
                    ...
                    print(
                        f"[EXP1] memory method={method} payload={payload_size} "
