// Client: sudo ./rx_dma_assisted -deviceName mlx5_2 -batch_size 1 -outstanding 32 -nodeType 0 -payload_size 8192 -threads 12 -nb_rxd 64 -nb_txd 64 -pkt_buf_size 8192 -pkt_handle_batch 1
// Relay:  sudo ./rx_dma_assisted -deviceName mlx5_2 -batch_size 1 -outstanding 32 -nodeType 1 -payload_size 8192 -threads 12 -nb_rxd 64 -nb_txd 64 -pkt_buf_size 8192 -pkt_handle_batch 1
// Server: sudo ./rx_dma_assisted -deviceName mlx5_0 -batch_size 1 -outstanding 32 -nodeType 2 -payload_size 8192 -threads 12 -serverIp 10.0.0.201 -nb_rxd 64 -nb_txd 64 -pkt_buf_size 8192 -pkt_handle_batch 1
...
void benchmark() {
    ...
    if (FLAGS_nodeType == RELAY) {
        printf("RESULT|experiment=2|method=rx_dma_assisted|payload_size=%lu|threads=%lu|total_gbps=%.6f\n",
