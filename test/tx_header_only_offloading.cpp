// Client: sudo ./tx_header_only_offloading -deviceName mlx5_0 -batch_size 1 -outstanding 32 -nodeType 0 -threads 2 -payload_size 1024 -serverIp 10.0.0.101
// Relay:  sudo ./tx_header_only_offloading -deviceName mlx5_2 -batch_size 1 -outstanding 32 -nodeType 1 -threads 2 -payload_size 1024
// Server: sudo ./tx_header_only_offloading -deviceName mlx5_2 -batch_size 1 -outstanding 32 -nodeType 2 -threads 2 -payload_size 1024
...
void benchmark() {
    ...
    if (FLAGS_nodeType == RELAY) {
        printf("RESULT|experiment=1|method=tx_header_only_offloading|payload_size=%lu|threads=%lu|total_gbps=%.6f\n",
