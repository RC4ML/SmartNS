...
#define SMARTNS_LOG_LEVEL_INFO 3    // Reasonable to log (e.g., management packets)
#define SMARTNS_LOG_LEVEL_REORDER 4 // Too frequent to log (e.g., reordered pkts)
#define SMARTNS_LOG_LEVEL_TRACE 5   // Extremely frequent (e.g., all datapath pkts)
#define SMARTNS_LOG_LEVEL_CC 6      // Even congestion control decisions!

#define SMARTNS_LOG_DEFAULT_STREAM stdout
...
#define SMARTNS_REORDER(...)                                      \
    ...
    fflush(smartns_trace_file_or_default_stream)
#else
#define SMARTNS_REORDER(...) ((void)0)
#endif
